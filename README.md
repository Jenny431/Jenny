...
<head>
    ...
    <title>Jenny J. - Technical Consultant</title>
    <style>
        body {
        ...
        .about, .experience, .education, .skills, .objectives {
            background: #ffffff;
            padding: 30px;
            margin-top: 30px;
            border-radius: 5px;
        ...
        .about p, .experience p, .education p, .skills p, .objectives p {
            font-size: 18px;
        }
...
<div class="container">
    ...
    <section id="experience" class="experience">
        ...
        <h3>Alibaba Group | Senior Cloud Architect</h3>
        <p><em>2012 - 2016</em></p>
